...
function Resources() {
    return (
        <Default>
            <div className=" bg-primary text-white text-5xl font-black grid place-content-center hover:animate-pulse">DEFINING AI</div>
            ...
            <div className="bg-secondary text-white text-5xl font-black grid place-content-center hover:animate-pulse my-3">AI IN CANADA</div>
            <div className="flex flex-col md:flex-row">
            ...
            <div className="bg-accent text-white text-5xl font-black grid place-content-center hover:animate-pulse my-3">AI ETHICS</div>
            <div className="flex flex-col md:flex-row">
                {Card("https://www.ibm.com/content/dam/connectedassets-adobe-cms/worldwide-content/creative-assets/s-migr/ul/g/83/11/maximo_maintenance1_management.component.xl.ts=1706705365513.png/content/adobe-cms/us/en/topics/artificial-intelligence/jcr:content/root/leadspace",
