...
function Content() {
  return (
    ...
    <div className= "bg-[#A6242F] relative -z-20">
      <div className="min-h-[100vh] w-full inset-0 bg-[#A6242F] p-7 flex flex-col select-none mb-[50vh] rounded-[60px]">
    ...
    <div>
    <div className="border-blue-300 border-4 fixed bottom-0 right-0 text-white bg-[#8C1616] -z-10 w-full h-[60vh]">
        <div className="border-yellow-300 border -2 flex flex-col w-full">
