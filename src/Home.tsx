  ...
  return (
    ...
    <input id="my-drawer-4" type="checkbox" className="drawer-toggle" onChange={(e) => { setIsOpen(e.target.checked) }} />
      ...
      <div className="min-h-[100vh] w-full inset-0 bg-[#A6242F] p-7 flex flex-col select-none mb-[50vh] rounded-[5rem] relative z-20">
        <nav id='' className="lowercase fixed top-0 right-0 m-4 flex">
          <div>
        ...
        <div className="flex">        
          <div className=" w-[33.33%] m-auto">
            <div className='flex space-x-[12%]'>
              ...
              <a className=' fill-current hover:text-[#f2f2f2]' href="https://www.linkedin.com/company/encode-justice-canada/?trk=organization_guest_main-feed-card-text">
              ...
              <svg className='w-10 fill-current hover:text-[#f2f2f2]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310 310" xml:space="preserve">
          ...
          <div className=" w-[33.33%] text-center m-auto text-[1.75rem] pr-32">
            Join our <a className="hover:text-[#f2f2f2] hover:underline" href="">Slack!</a>
          </div>
          <div className=' w-[33.33%] text-[1.5rem] mb-20 px-7'>
            ...
            <div className='flex space-x-4 pt-4'>
              ...
              <div className='border-[3px] border-[#f2bbbb] bg-[#f2bbbb] rounded-full w-[12.5%] text-center text-[#8C1616] hover:cursor-pointer hover:bg-[#f2f2f2] hover:border-[#f2f2f2]' onClick={() => navigate("/newsletter")}>
