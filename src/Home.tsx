      ...
      <div className="flex flex-1 container mx-auto p-5 justify-center">
        <div className="flex flex-col md:flex-row items-center justify-center mb-2 gap-6 lg:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <p className=" text-white text-5xl md:text-6xl lg:text-8xl italic font-black text-center tracking-widest font-['Lato'] p-2 animate-fadeIn">ENCODE yoo JUSTICE<br />CANADA</p>
