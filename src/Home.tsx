...
function Content() {
  return (
    <>
      ...
      <div className="min-h-[100vh] w-full inset-0 bg-[#A6242F] p-7 flex flex-col select-none mb-[50vh] rounded-[5rem] relative z-50">
        <div className=" flex-col flex-1 container mx-auto p-5 justify-center relative z-50">
      ...
      <div className=" bg-[#8C1616] fixed bottom-0 right-0 text-white  w-full h-[60vh] pt-36 px-20 z-10">
        <div className=" text-white text-[2.75rem] md:text-[2.75rem] font-bold relative z-0">
  ...
  return (
    <div className="drawer drawer-end">
      ...
      <div className="drawer-content">
        <nav id='' className="lowercase fixed top-0 right-0 z-20 lg:flex">
