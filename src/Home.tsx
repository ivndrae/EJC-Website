      ...
      <footer className=" bg-[#8C1616] fixed bottom-0 right-0 w-full h-full pt-32 md:pt-36 px-5 md:px-20 z-10 text-[#F2BBBB]">
        <div className='absolute bottom-0 mb-10'>
          ...
          <div className=" space-y-7 flex flex-col sm:flex-row">        
            <div className="md:w-[33.33%] mt-[5%] items-center sm:text-left">
              <div className='flex space-x-[12%] text-[2rem] md:text-4xl items-center justify-center'>
              ...
              <a className="text-[1.2rem] md:text-[1.35rem] hover:text-[#f2f2f2] flex text-center" href="mailto:encodejusticecanada@gmail.com"><div className='m-auto'>encodejusticecanada@gmail.com</div></a>  
            </div>
            ...
            <div className=' md:w-[33.33%] text-[1.25rem] md:text-[1.5rem] leading-6 px-3 md:px-7'>
