            ...
            <form method="post" action="" name="contact-form">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <input className="w-full h-7 placeholder:text-gray-500" type="text" name="your-name" placeholder="e.g. John Smith" />
                </div>
                <div>
                  <div>Email address:</div>
                  <input className="w-full h-7 placeholder:text-gray-500" type="text" name="your-email" placeholder="example@encodejustice.ca" />
                </div>
                <div>
                  <div>Message:</div>
